...
from bay_area_courtbot.paths import project_root, state_dir
from bay_area_courtbot.timeutil import next_window_open

LAUNCHAGENTS = Path.home() / "Library" / "LaunchAgents"
RACER_TMPL = project_root() / "launchd" / "ai.zipline.bay-area-courtbot.racer.plist.tmpl"
...
def install_racer_for_facility(
    ...
    *,
    ...
    out = LAUNCHAGENTS / f"ai.zipline.bay-area-courtbot.racer.{facility.org_id}.plist"
